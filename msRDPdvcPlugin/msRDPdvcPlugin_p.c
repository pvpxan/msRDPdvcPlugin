...
typedef struct _msRDPdvcPlugin_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } msRDPdvcPlugin_MIDL_TYPE_FORMAT_STRING;

typedef struct _msRDPdvcPlugin_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } msRDPdvcPlugin_MIDL_PROC_FORMAT_STRING;

typedef struct _msRDPdvcPlugin_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } msRDPdvcPlugin_MIDL_EXPR_FORMAT_STRING;
...
extern const msRDPdvcPlugin_MIDL_TYPE_FORMAT_STRING msRDPdvcPlugin__MIDL_TypeFormatString;
extern const msRDPdvcPlugin_MIDL_PROC_FORMAT_STRING msRDPdvcPlugin__MIDL_ProcFormatString;
extern const msRDPdvcPlugin_MIDL_EXPR_FORMAT_STRING msRDPdvcPlugin__MIDL_ExprFormatString;
...
static const msRDPdvcPlugin_MIDL_PROC_FORMAT_STRING msRDPdvcPlugin__MIDL_ProcFormatString =
    {
        0,
        {
...
static const msRDPdvcPlugin_MIDL_TYPE_FORMAT_STRING msRDPdvcPlugin__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* RegisterComponent */
    { 
    /* RegisterComponent */      /* procedure RegisterComponent */
        (NDR64_UINT32) 2883907 /* 0x2c0143 */,    /* auto handle */ /* IsIntrepreted, [object], ClientMustSize, HasReturn, ServerCorrelation */
        (NDR64_UINT32) 24 /* 0x18 */ ,  /* Stack size */
        (NDR64_UINT32) 0 /* 0x0 */,
        (NDR64_UINT32) 8 /* 0x8 */,
...
{ 
/* *FLAGGED_WORD_BLOB, *FLAGGED_WORD_BLOB, *FLAGGED_WORD_BLOB */
    0x22,    /* FC64_OP */
    (NDR64_UINT8) 0 /* 0x0 */,
    (NDR64_UINT16) 0 /* 0x0 */,
    &__midl_frag5
...
/* RegisterAll */
    { 
    /* RegisterAll */      /* procedure RegisterAll */
        (NDR64_UINT32) 524611 /* 0x80143 */,    /* auto handle */ /* IsIntrepreted, [object], HasReturn */
        (NDR64_UINT32) 16 /* 0x10 */ ,  /* Stack size */
        (NDR64_UINT32) 0 /* 0x0 */,
        (NDR64_UINT32) 8 /* 0x8 */,
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    msRDPdvcPlugin__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    msRDPdvcPlugin__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
const CInterfaceProxyVtbl * const _msRDPdvcPlugin_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _msRDPdvcPlugin_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _msRDPdvcPlugin_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  const _msRDPdvcPlugin_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _msRDPdvcPlugin_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _msRDPdvcPlugin, pIID, n)

int __stdcall _msRDPdvcPlugin_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_msRDPdvcPlugin_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo msRDPdvcPlugin_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _msRDPdvcPlugin_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _msRDPdvcPlugin_StubVtblList,
    (const PCInterfaceName * ) & _msRDPdvcPlugin_InterfaceNamesList,
    (const IID ** ) & _msRDPdvcPlugin_BaseIIDList,
    & _msRDPdvcPlugin_IID_Lookup, 
    1,
    2,
