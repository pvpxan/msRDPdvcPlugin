...
#ifndef __msRDPdvcPlugin_i_h__
#define __msRDPdvcPlugin_i_h__
...
#ifndef __msRDPdvcPluginLib_LIBRARY_DEFINED__
#define __msRDPdvcPluginLib_LIBRARY_DEFINED__

/* library msRDPdvcPluginLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_msRDPdvcPluginLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("7e6e7425-ac71-4e62-9752-8235a3ef2ae9")
CompReg;
#endif
#endif /* __msRDPdvcPluginLib_LIBRARY_DEFINED__ */
